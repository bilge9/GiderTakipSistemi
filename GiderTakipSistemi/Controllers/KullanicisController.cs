...
namespace GiderTakipSistemi.Controllers
{
    public class KullanicisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,KullaniciAdi,Email,Sifre")] Kullanici kullanici)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,KullaniciAdi,Email,Sifre")] Kullanici kullanici)
        {
            if (id != kullanici.Id)
            {
                return NotFound();
